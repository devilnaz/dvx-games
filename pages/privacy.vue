			...
			<main class="main-content">
				<div class="privacy">
					...
					<p>
						...
						Informationen allgemeiner Natur erfasst. Diese<br />
					...
					<p>
						...
						Basis unseres berechtigten Interesses an der Verbesserung
						der<br />
					...
					<p>
						...
						die der<br />
						Bereitstellung der Webseite dienen, grundsätzlich der Fall,
					...
					<p>
						...
						ist weder gesetzlich noch vertraglich<br />
						vorgeschrieben. Ohne die IP-Adresse ist jedoch der Dienst und
						die Funktionsfähigkeit unserer Website nicht gewährleistet.
						Zudem können einzelne<br />
						Dienste und Services nicht verfügbar oder eingeschränkt sein.
						Aus diesem Grund ist ein Widerspruch ausgeschlossen.<br />
					</p>
					...
					<p>
						...
						die Verwendung von Cookies erlauben, können<br />
					...
					<ol>
						...
						<li>
							...
							<a
								...
								>support.apple.com/kb/PH17191?locale=de_DE&viewlocale=de_DE</a
							>
						</li>
					</ol>
					...
					<p>
						...
						bereitgestellt werden. Beim Aufruf einer<br />
					...
					<p>
						Um die Sicherheit bei einem Besuch auf unserer Webseite zu
						erhöhen, verwenden wir dem aktuellen Stand der Technik
						entsprechende<br />
					...
					<p>
						...
						Datenschutz verantwortliche<br />
