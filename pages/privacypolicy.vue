			...
			<main class="main-content">
				<div class="privacy">
					...
					<p>
						...
						Website, Auswertung der Systemsicherheit und -stabilität sowie
					...
					<p>
						...
						die Verwendung von Cookies erlauben, können folgende Cookies
						auf unseren Webseiten zum Einsatz kommen:
					</p>
					...
					<p>
						...
						gelöscht oder deren Speicherung vorab blockiert werden können.
						Je nach Anbieter Ihres Browsers finden Sie die notwendigen
					...
					<p>
						...
						Verbindung zu den Servern von Google zum Nachladen der
						jeweiligen Fonts aufgebaut.
					</p>
					...
					<p>
						...
						einen Einbindung JavaScript-Blocker installieren. Bitte
						beachten Sie, dass es hierdurch zu Funktionseinschränkungen
