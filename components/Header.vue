	...
	<div>
		<div class="wrap-container">
			<div class="header">
				...
				<div class="header__navigate">
					<nav class="navigate">
						<ul class="navigate__list">
							<li>
								<NuxtLink to="contact-form" class="navigate__link">
									Contact
								</NuxtLink>
							</li>
							<li>
								<NuxtLink to="privacypolicy" class="navigate__link">
									Privacy Policy
								</NuxtLink>
							</li>
							<li>
				...
				<div
					class="menu-burger"
					:status="modal_status == 'close' ? 'close' : 'open'"
				>
					<button @click="toggle_menu" class="menu-burger__btn-open">
						<img
							class="menu-burger__btn-open-img"
							src="/img/burger.svg"
							alt="img: burger-menu-btn"
						/>
					</button>
					<div class="menu-burger__container">
						<div
							@click.self="toggle_menu"
							class="menu-burger__ground"
						></div>
						<div class="menu-burger__body">
							<button
								@click="toggle_menu"
								class="menu-burger__btn-close"
							>
